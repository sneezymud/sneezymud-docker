          ...
          <>
            ...
            <Popover>
              <PopoverTrigger
                ...
                className="hover:bg-accent dark:bg-background/60 border-input focus-visible:border-primary/50 focus-visible:ring-ring/50 h-9 w-full rounded-md border px-2 py-1 text-left text-sm shadow-xs transition-[color,border-color,box-shadow] duration-150 outline-none focus-visible:ring-[3px]"
              >
                {count > 0
