...
export const directionLabels = new Map(
  DIRECTION_TYPES.map(({ label, value }) => [value, label]),
);

export function exitFields(prefix: string): FieldDef[] {
  return [
    {
      fullWidth: true,
      key: `${prefix}-name`,
...
export function toExitKey(fieldKey: string, prefix: string): keyof RoomExit {
